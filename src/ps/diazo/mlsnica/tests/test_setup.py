# -*- coding: utf-8 -*-
"""Test Setup of ps.diazo.mlsnica."""
...
CSS = [
    '++resource++ps.diazo.mlsnica/main.css',
]

JS = [
    '++resource++ps.diazo.mlsnica/main.js',
]


class TestSetup(unittest.TestCase):
    """Validate setup process for ps.diazo.mlsnica."""

    layer = testing.PS_DIAZO_MLSNICA_INTEGRATION_TESTING
